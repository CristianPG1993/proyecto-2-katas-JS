...
// de los X-Men y su año de aparición. La función debe retornar el miembro más antiguo.
...
console.log(`El miembro más antiguo de los X-Men es: ${oldestXMen.name}, que apareció en el año ${oldestXMen.year}.`);